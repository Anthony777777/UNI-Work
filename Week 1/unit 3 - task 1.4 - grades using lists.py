...
# input the score and using the number input pulls the corresponding position of the grade
#ie input 3 and it looks for the 3rd entry in the list mid fail
